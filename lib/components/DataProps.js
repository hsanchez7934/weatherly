export default function DataProps(data){
  ...
  this.hourOneHour = data.hourly_forecast[1].FCTTIME.hour;
  this.hourTwoHour = data.hourly_forecast[2].FCTTIME.hour;
  this.hourThreeHour = data.hourly_forecast[3].FCTTIME.hour;
  this.hourFourHour = data.hourly_forecast[4].FCTTIME.hour;
  this.hourFiveHour = data.hourly_forecast[5].FCTTIME.hour;
  this.hourSixHour = data.hourly_forecast[6].FCTTIME.hour;
  this.hourSevenHour = data.hourly_forecast[7].FCTTIME.hour;
